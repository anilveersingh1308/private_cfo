...
export const Card: React.FC<CardProps> = ({ 
  ...
  return (
    <div className={`admin-card ${hover ? 'hover-effect' : ''} ${gradient ? 'gradient' : ''} ${className}`}>
      {children}
      <style jsx>{`
        .admin-card {
...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      className={`admin-btn ${variant} ${size} ${disabled ? 'disabled' : ''}`}
    >
      {loading ? (
