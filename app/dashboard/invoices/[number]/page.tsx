...
export default function InvoiceViewEdit() {
  ...
  const handleDuplicate = () => {
    if (invoice) {
      router.push(`/dashboard/invoices/new?duplicate=${invoice.id}`);
    }
  };
      ...
      <div className="invoice-content">
        ...
        <div className="invoice-form-grid">
          ...
          <Card className="form-section">
            ...
            <div className="form-grid">
              <div className="form-field">
                <label className={formErrors.client_name ? 'error' : ''}>
                ...
                {isEditMode ? (
                  <input
                    ...
                    disabled={saving}
                    className={formErrors.client_name ? 'error' : ''}
                  />
                ) : (
                  <div className="read-only-value">{invoice.client_name}</div>
                )}
                {formErrors.client_name && <span className="error-message">{formErrors.client_name}</span>}
              </div>

              <div className="form-field">
                <label className={formErrors.client_email ? 'error' : ''}>
                ...
                {isEditMode ? (
                  <input
                    ...
                    disabled={saving}
                    className={formErrors.client_email ? 'error' : ''}
                  />
                ) : (
                ...
                {formErrors.client_email && <span className="error-message">{formErrors.client_email}</span>}
              </div>
          ...
          <Card className="form-section">
            ...
            <div className="form-grid">
              <div className="form-field">
                <label className={formErrors.service_type ? 'error' : ''}>
                ...
                {isEditMode ? (
                  <select
                    ...
                    disabled={saving}
                    className={formErrors.service_type ? 'error' : ''}
                  >
                ...
                {formErrors.service_type && <span className="error-message">{formErrors.service_type}</span>}
              </div>
              ...
              <div className="form-field">
                <label className={formErrors.amount ? 'error' : ''}>
